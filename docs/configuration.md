...
| `bi_level_gae` | turn-level outer chain, token-level inner | `+algorithm.high_level_gamma` |
| `bi_level_gae_varlam` | as above with a separate inner λ | `+algorithm.lam_low` |
