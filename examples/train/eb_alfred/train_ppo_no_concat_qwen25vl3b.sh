...
REF_MODEL_PATH=/workspace/.hf_home/hub/models--err00rr--Qwen2.5-VL-3B-Instruct-EB-ALFRED-vagen-sft/snapshots/3ab58797a74bcc4198e140166d935533a82d28f7
mkdir -p ${EXPERIMENT_DIR}

export HF_HOME=/workspace/.hf_home
export PATH=/venv/vagen/bin:$PATH
export LD_LIBRARY_PATH=/venv/vagen/lib/python3.12/site-packages/nvidia/cuda_runtime/lib:${LD_LIBRARY_PATH}
...
PYTHONUNBUFFERED=1 python3 -m vagen.main_ppo \
    ...
    +data.max_trajectory_length=100000 \
