#!/bin/bash
# Primitive skill environment training with PPO (all 4 tasks jointly)
#
...
EXPERIMENT_NAME="primitive_skill_ppo_qwen25vl3b"

BASEDIR=$(pwd)
SCRIPTDIR=$(dirname "$0")
EXPERIMENT_DIR=${BASEDIR}/exps/${PROJECT_NAME}/${EXPERIMENT_NAME}
SAVE_CHECKPOINT_DIR=${EXPERIMENT_DIR}/verl_checkpoints
DATASET_TRAIN=${SCRIPTDIR}/train_primitive_skill.yaml
DATASET_VAL=${SCRIPTDIR}/val_primitive_skill.yaml
