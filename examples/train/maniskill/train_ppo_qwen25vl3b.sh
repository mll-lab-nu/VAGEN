...
# Before running, start the ManiSkill server in another terminal:
#   python -m vagen.envs.maniskill.serve

PROJECT_NAME="vagen_experiments"
EXPERIMENT_NAME="ppo_maniskill_qwen25vl3b"

BASEDIR=$(pwd)
SCRIPTDIR=$(dirname "$0")
EXPERIMENT_DIR=${BASEDIR}/exps/${PROJECT_NAME}/${EXPERIMENT_NAME}
SAVE_CHECKPOINT_DIR=${EXPERIMENT_DIR}/verl_checkpoints
DATASET_TRAIN=${SCRIPTDIR}/train_maniskill.yaml
DATASET_VAL=${SCRIPTDIR}/val_maniskill.yaml
