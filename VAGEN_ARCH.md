...
| Algorithm layer | ✅ `episode_gae` (baseline), `token_level_gae`, `bi_level_gae`, `turn_level_gae`, `trajectory_grpo`, all on `TrajectoryView`. `no_concat_gae` deleted 2026-08-08; `episode_gae` added 2026-08-09 |
