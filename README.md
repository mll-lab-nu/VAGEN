...
**VAGEN-Lite** is a lightweight implementation of **VAGEN** built on top of the **VERL agent-loop framework** for easy customization, fast trainig, and stable performance.
