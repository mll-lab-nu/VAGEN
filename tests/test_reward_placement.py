...
* an estimator with one reward slot per turn (``removed_estimator_gae`` reads a turn's reward
...
def test_an_explicit_setting_overrides_auto():
    ...
    assert resolve_reward_placement(_cfg("removed_estimator_gae"), "per_span") == "per_span"
