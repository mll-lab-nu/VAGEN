"""A policy loss whose unit of action is a turn, not a token and not a row.
    ...
    *, old_log_prob, log_prob, advantages, response_mask, config, rollout_is_weights,
    ...
    if turn_id is None:
        raise ValueError(
            ...
            "the trajectory advantage estimators (token_level_gae, removed_estimator_gae_varlam, "
            "turn_level_gae); with verl's own gae or grpo there is nothing that says "
